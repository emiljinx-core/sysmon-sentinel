...
train_df = pd.read_csv(r"C:\SLM_Project\logs\train.csv")
val_df = pd.read_csv(r"C:\SLM_Project\logs\val.csv")
test_df = pd.read_csv(r"C:\SLM_Project\logs\test.csv")
...
trainer.save_model("./tinybert-sysmon-final")
print("TinyBERT saved to ./tinybert-sysmon-final")
